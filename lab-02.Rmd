...
```
1.1 Did not particularly expect this result - based on a quick google search Trinidad and Tobago appears to have a waste problem due to a variety of issues from high import volume, poor infrastructure, and limited land for landfills. Many of the countries hover around 0.25 kg/person with a cluster falling below that and into the negative. 
...
```
3.1 
Violin plots better show the distribution of our data, specifically the density. Whereas, boxplots bbetter show summary statistics such as the median, quartiles, and outliers. 
### Exercise 4
